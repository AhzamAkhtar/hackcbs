...
const Hero = () => {
    return (
        <>
            <section class="bg-[url('/backgroundim.svg')] dark:bg-gray-900">
                <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
                    <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl text-white">Revolutionize OTT & Empower Movie Makers: End Password Sharing Woes!</h1>
                    <p class="mb-8 text-lg font-normal text-white lg:text-xl sm:px-16 lg:px-48 dark:text-gray-400">Revolutionize the way you stream and create films – our platform ends password sharing frustrations, offering security and creative freedom."</p>
                    ...
                    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
                        ...
                        <div class="grid md:grid-cols-2 gap-8">
                            <div class="bg-gray-950 dark:bg-gray-950 dark:border-gray-700 rounded-lg p-8 md:p-12">
                                ...
                                <h2 class="text-white dark:text-white text-3xl font-extrabold mb-2">Secure platform with NFT Authentication</h2>
                                <p class="text-lg font-normal text-white dark:text-gray-400 mb-4">Each piece of content like movie, show and series is assigned with unique NFT. This NFT is linked to the user's account when they purchase or subscribe to the content.</p>
                            </div>
                            <div class="bg-gray-950 dark:bg-gray-800 dark:border-gray-700 rounded-lg p-8 md:p-12">
                                ...
                                <h2 class="text-white dark:text-white text-3xl font-extrabold mb-2">Maximize the platform's revenue.</h2>
                                <p class="text-lg font-normal text-white dark:text-gray-400 mb-4">Content creators and streaming platform can maximize their revenue by preventing unauthorized access to their content.</p>
                            </div>
                        </div>
                    </div>
                </section>
